...
if (requireNamespace("MASS")) {
  ...
  movie3d(spin3d(axis = c(0,0,1), rpm = 4), duration = 1, fps = 50, convert = FALSE, clean = FALSE, dir=getwd())

# Create a movie
  movie3d(spin3d(axis = c(0, 0, 1)), duration = 1, fps = 50,dir = getwd(), clean = FALSE)
  #play3d(spin3d(axis = c(0, 0, 1)), duration = 3)
...
open3d()
#plot3d(ellipse3d(fit, level = 0.5
                 #0), col = "blue", alpha = 0.5, aspect = TRUE)
